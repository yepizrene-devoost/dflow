...
Status: #8 delivered and closed, merged into develop; #9 pending
...
Commit/push/merge/issue closure: authorized by the user and completed after verification.
...
- Commit `30cd4d6` (docs plus CLI tests) merged into `develop` as `25f296d` and pushed.
- Issue #8 closed as completed; `#9` (child rebase) and `#12` (failure exit codes) remain open.
